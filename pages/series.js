	...
	<Layout>
		<div className="MovieInFocus"> 
                    ...
                    <div className="trailerWrapper">
                        <iframe width="100%" height="543" src="https://www.youtube.com/embed/FHxhr6KAaUw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                        </iframe>
                    </div>
